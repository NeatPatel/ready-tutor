...
function PrivacyPolicy(){
    return(<>
        <Card className= {styles.privacyCard + ' w-50 mx-auto mt-3'}>
        <div className='text-secondary'><h1 className= 'text-dark text-center'>Privacy Policy</h1>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ready Tutor.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Ready Tutor, accessible from <a href="https://readytutor.org" rel="external nofollow noopener" target="_blank">https://readytutor.org</a></p>
        </li>
        <li>
