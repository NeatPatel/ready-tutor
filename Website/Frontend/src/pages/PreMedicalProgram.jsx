    ...
    return (<>
        <ContentBlock mt='25' mb='25' content={<>
            ...
            <div className="text-center mb-5">
                <img src={people7} alt="Medical Students Collaboration" className="img-fluid rounded shadow-lg" style={{maxHeight: '400px', width: '100%', objectFit: 'cover'}} />
            </div>
                    ...
                    <Col lg={10}>
                        <Card className="shadow-lg border-0 mb-5">
                            <Card.Body className="p-5">
                                <Row>
                                    ...
                                    <Col md={4}>
                                        <img src={people5} alt="Science Laboratory Work" className="img-fluid rounded shadow" style={{height: '250px', width: '100%', objectFit: 'cover'}} />
                                    </Col>
                                </Row>
                            </Card.Body>
                        </Card>
                        ...
                        <Card className="shadow-lg border-0 mb-5">
                            <Card.Body className="p-5">
                                <Row>
                                    <Col md={4}>
                                        <img src={people6} alt="Students in Medical Setting" className="img-fluid rounded shadow mb-3" style={{height: '200px', width: '100%', objectFit: 'cover'}} />
                                    </Col>
                                    <Col md={8}>
                        ...
                        <Card className="shadow-lg border-0 mb-5">
                            <Card.Body className="p-5">
                                <Row>
                                    ...
                                    <Col md={4}>
                                        <img src={people3} alt="Medical Program Students" className="img-fluid rounded shadow" style={{height: '200px', width: '100%', objectFit: 'cover'}} />
                                    </Col>
                                </Row>
                            </Card.Body>
                        </Card>
