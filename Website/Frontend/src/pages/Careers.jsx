...
function Careers() {
    return (<>
        ...
        <SplitContentBlock mt="0" mb="50" left={<>
            ...
            <a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSfP6BYptT5MpeVt3sGCzhQgn0457NerODAfqJRGM6dqbbDq0w/viewform"><button className="btn btn-dark rounded-pill px-4 py-3">Apply</button></a>
        </>} />
    </>);
}
