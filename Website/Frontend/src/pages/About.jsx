...
Why navigate alone? Here at Ready Tutor, we are here to help you out on your academic journey and all problems that you facing, with examples and stories to help you learn and remember everything that you need!
        ...
        <SplitContentBlock mt='30' mb='25' left={<><h2 className= 'text-center m-auto text-light'>Why Wait?<br/>Get a Free Consultation Today!</h2><br/><Link to='/contact-us'><Button variant="outline-info">Get Started</Button></Link></>} right={<Image src={waggImg} fluid className='pe-none' />}/>
        </>);
}
